...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Design-UI%2FUX-ff69b4" />
</p>

<h1 align="center">✨ Hyun Sumin — Portfolio README ✨</h1>

---

# 1. 👋 About Me

저는 컴퓨터공학과 4학년으로, **프론트엔드 개발자**를 목표로 공부하고 있습니다.  
사용자가 자연스럽게 **“아 이거 편하다”**라고 느끼는 순간을 만드는 데 가장 큰 즐거움을 느낍니다.

2025 관광데이터공모전에서 **NAvi(야외 방탈출 프로젝트)** 로 장려상을 수상했고,  
개인적으로는 **단주차(캠퍼스 주차 앱)**, **DayFrame(커스텀 플래너 앱)** 을 직접 설계·구현했습니다.

최근에는 **React 기반 개발**, **UI/UX 개선**, **상호작용 중심 프론트엔드 아키텍처**에 집중하고 있습니다.
